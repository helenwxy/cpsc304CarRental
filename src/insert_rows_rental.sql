...
insert into vehicle values (1, '111AAA', 'Honda', 'Civic', 2001, 11111, 'Available', 'Compact', 'East Vancouver', 'Vancouver');
insert into vehicle values (2, '222BBB', 'Toyota', 'Corolla', 2002, 22222, 'Available', 'Mid-size', 'Surrey', 'Surrey');
insert into vehicle values (3, '333CCC', 'Hyundai', 'Elantra', 2003, 33333, 'Available', 'Compact', 'Burnaby', 'Burnaby');
insert into vehicle values (4, '444DDD', 'Mazda', 'Maxda3', 2004, 44444, 'Available', 'Compact', 'Burnaby', 'Burnaby');
...
insert into reservation values (1, 'Economy', 'GA123456', TO_DATE('01-JAN-2001 08:20:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2001 16:40:00','DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (2, 'Compact', 'GA123456', TO_DATE('02-APR-2001 10:10:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('02-APR-2001 11:40:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (3, 'Compact', 'GC222222', TO_DATE('03-APR-2003 00:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('31-DEC-2003 23:59:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (4, 'Mid-size', 'BA112345', TO_DATE('14-AUG-2014 15:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('17-AUG-2014 19:30:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (5, 'Standard', 'AC123145', TO_DATE('25-MAY-2005 05:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('29-JUL-2005 13:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (6, 'Full-size', 'II444444', TO_DATE('16-NOV-2003 06:06:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('06-JAN-2004 18:16:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (7, 'SUV', 'II444444', TO_DATE('04-FEB-2003 04:52:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('15-JUN-2003 12:23:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (8, 'Standard', 'VV123123', TO_DATE('08-AUG-2008 08:48:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('09-SEP-2009 21:39:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );
insert into reservation values (9, 'Full-size', 'VV123123', TO_DATE('09-SEP-2009 21:40:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('09-SEP-2009 22:40:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2000 16:40:00','DD-MM-YYYY HH24:MI:SS') );

insert into rental values (1, '111AAA', 'GA123456', TO_DATE('01-JAN-2001 08:20:00','DD-MM-YYYY HH24:MI:SS'), TO_DATE('01-MAR-2001 16:40:00','DD-MM-YYYY HH24:MI:SS'), 5, 'Mastercard', 5000123412341234, TO_DATE('01-2020', 'MM-YYYY'), 1);
insert into rental values (2, '111AAA', 'GA123456', TO_DATE('02-APR-2001 10:10:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('02-APR-2001 11:40:00', 'DD-MM-YYYY HH24:MI:SS'), 10, 'Mastercard', 5000234523452345, TO_DATE('02-2020', 'MM-YYYY'), 2);
insert into rental values (3, '111AAA', 'GC222222', TO_DATE('03-APR-2003 00:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('31-DEC-2003 23:59:00', 'DD-MM-YYYY HH24:MI:SS'), 15, 'Mastercard', 5000345634563456, TO_DATE('03-2020', 'MM-YYYY'), 3);
insert into rental values (4, '444DDD', 'BA112345', TO_DATE('14-AUG-2014 15:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('17-AUG-2014 19:30:00', 'DD-MM-YYYY HH24:MI:SS'), 20, 'Mastercard', 5000456745674567, TO_DATE('04-2020', 'MM-YYYY'), 3);
insert into rental values (5, '555EEE', 'AC123145', TO_DATE('25-MAY-2005 05:00:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('29-JUL-2005 13:00:00', 'DD-MM-YYYY HH24:MI:SS'), 25, 'Visa', 4111432143214321, TO_DATE('05-2020', 'MM-YYYY'), 4);
insert into rental values (6, '666FFF', 'II444444', TO_DATE('16-NOV-2003 06:06:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('06-JAN-2004 18:16:00', 'DD-MM-YYYY HH24:MI:SS'), 30, 'Visa', 4111543254325432, TO_DATE('06-2020', 'MM-YYYY'), 4);
insert into rental values (7, '777GGG', 'II444444', TO_DATE('04-FEB-2004 04:52:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('15-JUN-2003 12:23:00', 'DD-MM-YYYY HH24:MI:SS'), 35, 'Visa', 4111654365436543, TO_DATE('07-2020', 'MM-YYYY'), 5);
insert into rental values (8, '888HHH', 'VV123123', TO_DATE('08-AUG-2008 08:48 AM', 'DD-MM-YYYY HH:MI AM'), TO_DATE('09-SEP-2009 09:39 PM', 'DD-MM-YYYY HH:MI PM'), 40, 'Mastercard', 3222123443211234, TO_DATE('08-2020', 'MM-YYYY'), 5);
insert into rental values (9, '999III', 'VV123123', TO_DATE('09-SEP-2009 21:40:00', 'DD-MM-YYYY HH24:MI:SS'), TO_DATE('09-SEP-2009 22:40:00', 'DD-MM-YYYY HH24:MI:SS'), 45, 'Mastercard', 3222234554322345, TO_DATE('09-2020', 'MM-YYYY'), 5);
